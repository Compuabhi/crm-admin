...
@app.route("/crm/api/v1.0/account/<int:account_id>/member", methods=["GET"])
...
@app.route("/crm/api/v1.0/account/<int:account_id>/member/<int:member_id>", methods=["GET"])
...
@app.route("/crm/api/v1.0/account/<int:account_id>/member/<int:member_id>", methods=["PUT"])
...
@app.route("/crm/api/v1.0/account", methods=["POST"])
def create_account():
    incoming = request.get_json()
    print(incoming)
    try:
...
@app.route("/crm/api/v1.0/account/<string:account_id>", methods=["PUT"])
def update_account():
    pass

@app.route("/crm/api/v1.0/account/<string:account_id>", methods=["GET"])
